...
def load_dataset():
    train_dataset = h5py.File('/content/gdrive/MyDrive/Colab Notebooks/coursera programming practice/class4/week2/Residual Networks/datasets/train_signs.h5', "r")
    ...
    test_dataset = h5py.File('/content/gdrive/MyDrive/Colab Notebooks/coursera programming practice/class4/week2/Residual Networks/datasets/test_signs.h5', "r")
